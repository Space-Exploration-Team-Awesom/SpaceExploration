...
//------------------Object Declarations-----------//
 ...
 new Dev('Tray', './IMG/devImg/Tray.jpg', 'My name is Tray, and I am a Seattle based Software Developer. Iam an air force veteran that has served for 10 years. My hobbies include: anything food related, botany/plants, snowboarding, knitting, and polishing opals, fawning over my cat. I have a knack for oddball adventures like climbing up city rooftops and looking for artist graffiti all over town to photograph. I also have a thriving curiosity for all things language. Imagine this; from point of origin of human civilization, somehow, we have come up with thousands of different languages that span the entire planet. How? And why?');
